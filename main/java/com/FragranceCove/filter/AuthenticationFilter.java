package com.FragranceCove.filter;
...
public class AuthenticationFilter implements Filter {
	...
	private static final String TOTAL_PRODUCT= "/products";
	private static final String TOTAL_USERS= "/user";
	private static final String LOW_STOCK_PRODUCTS= "/products";
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if ("admin".equals(userRole)) {
			...
			} else if (uri.endsWith(DASHBOARD) || uri.endsWith(TOTAL_PRODUCTS) || uri.endsWith(TOTAL_PRODUCTS)
			...
			if (uri.endsWith(LOGIN) || uri.endsWith(REGISTER)) {
				...
				chain.doFilter(request, response);
			} else if (uri.endsWith(DASHBOARD) || uri.endsWith() || uri.endsWith(STUDENT_UPDATE)
